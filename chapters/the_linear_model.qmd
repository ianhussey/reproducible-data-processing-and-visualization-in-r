...
#| fig-height: 10
#| fig-width: 10
# Table of residual diagnostics
library(performance)
check_model(fit, panel = FALSE)        # returns individual plots printed
check_outliers(fit)                    # tests for outliers
check_normality(fit)                   # Shapiro-Wilk and visual
check_heteroscedasticity(fit)          # Breusch–Pagan
check_model(fit)                       # grid of residual and influence plots
