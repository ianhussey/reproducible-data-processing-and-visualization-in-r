# Structuring projects <span class="badge badge-draft3">✎ Small TODOs</span>
...
![](../images/psychdsish_logo.png){width="15%"}

Since first writing this chapter, I've turned this recommended structure into an R package, [{psychdsish}](https://github.com/ianhussey/psychdsish) ('psych-DS-ish'). It provides `create_project_skeleton()` to scaffold the folder structure above (with Quarto templates, a readme template, a CC BY licence, and a sensible `.gitignore` included), and `validator()` to check whether an existing project already complies with it. You can install the development version from GitHub:
...
Here's a demo of the project creator tool in action:

{{< video ../videos/psychdsish_project_creator.mov >}}
...
Pablo Mosteiro & Hanne Oberman's open source course materials [Markup Languages and Reproducible Programming in Statistics](https://mlarpis.github.io/)

https://bes-guide.github.io/reproducible-code/version-control.html
